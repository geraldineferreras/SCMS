      ...
      <Container className="mt-4" fluid>
        <Row>
          <Col md="12">
            ...
            <Card className="mb-4" style={{ border: '1px solid #e1e5e9', borderTopLeftRadius: 0, borderRadius: '8px' }}>
                  ...
                  <Col md="12" className="pl-3 pr-3">
                    ...
                    <div className="w-100 d-flex justify-content-between align-items-center" style={{ marginTop: '20px', marginBottom: '16px' }}>
                      <div style={{ fontWeight: 600, fontSize: '1.1rem', color: '#32325d' }}>
                        {activeCourseTab === "all" ? "All Courses" : courses.find(c => c.id === activeCourseTab)?.name || "Admin Attendance Log"} ({filteredData.length})
                      </div>
            ...
            {selectedRecord && (
              <div>
                <Row>
                  ...
                  <Col md={6}>
                    <h6 style={{ fontSize: '1.25rem', marginTop: '1.25rem' }}><i className="ni ni-calendar-grid-58 mr-2" style={{ color: '#5e72e4', fontSize: 18 }} />Attendance Details</h6>
